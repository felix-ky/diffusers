...
export INSTANCE_ID_FILE="../../data/LIP/CIHP/instance-level_human_parsing/Training/train_id.txt"
export INSTANCE_DIR="../../data/LIP/CIHP/instance-level_human_parsing/Training/Images/"
export INSTANCE_MASK_DIR="../../data/LIP/CIHP/instance-level_human_parsing/Training/Categories/"
...
accelerate launch \
  ...
  --instance_prompt="a photo of CIHP persons" \
  --resolution=512 \
  --train_batch_size=1 \
